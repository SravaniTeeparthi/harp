...
def random_value(value, random_negative_prob):
    """Randomly negate value based on random_negative_prob."""
    value = np.random.uniform(0,value)
    return -value if np.random.rand() < random_negative_prob else value
...
class Shear_sravani(object):
    ...
    def __call__(self, results):
        ...
        magnitude = random_value(self.magnitude, self.random_negative_prob)
